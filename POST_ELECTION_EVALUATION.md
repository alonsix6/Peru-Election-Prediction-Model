...
2. **25 encuestas de 6 casas**: la diversidad de fuentes reduce el sesgo de cualquier encuestadora individual. La última (Datum n=3000) tiene el menor margen de error del ciclo (±1.8%).
