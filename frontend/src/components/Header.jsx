...
export default function Header({ status, predictions }) {
  ...
  if (predictions?.generated_at_lima) {
    ...
    updatedDotColor = minsAgo < 35 ? '#22C55E' : minsAgo < 90 ? '#F59E0B' : '#EF4444';
    ...
    <header style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '10px' }}>
          <span style={{ color: '#CBD5E1', fontSize: '13px', fontVariantNumeric: 'tabular-nums', display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          {updatedText && (
            <span style={{
              ...
              <span style={{
                ...
                boxShadow: updatedDotColor === '#22C55E' ? `0 0 6px ${updatedDotColor}` : 'none'
              }} />
              <RefreshCw size={10} style={{ color: '#64748B' }} />
              {updatedText}
            </span>
          )}
        </div>
